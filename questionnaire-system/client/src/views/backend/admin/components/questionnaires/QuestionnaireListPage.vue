  ...
  <div class="questionnaire-list-page">
    ...
    <el-card class="list-card" shadow="never">
      ...
      <div v-if="viewMode === 'card'" class="card-view" v-loading="loading">
          ...
          >
            <div class="card-header">
              ...
              <div class="card-actions">
                <el-dropdown
                  @command="(command) => handleAction(command, questionnaire)"
                >
                  ...
                  <template #dropdown>
                    <el-dropdown-menu>
                      ...
                      <el-dropdown-item
                        command="online"
                        v-if="questionnaire.status === 'stopped'"
                        >上架</el-dropdown-item
                      >
                      <el-dropdown-item
                        command="setTemplate"
                        v-if="!questionnaire.isTemplate"
                        >设为模板</el-dropdown-item
                      >
                      <el-dropdown-item command="viewComments"
                        >问卷评论</el-dropdown-item
                      >
                      <el-dropdown-item
              ...
              <div class="card-stats">
                <span class="stat-item">
                  ...
                  {{
                    ...
                    questionnaire.participantCount ||
                    0
                  }}
                </span>
                <span class="stat-item">
        ...
        <!-- 空状态 -->
        <el-empty
          v-if="!paginatedList.length && !loading"
          description="暂无问卷数据"
        >
          <el-button type="primary" @click="createQuestionnaire"
            >创建第一个问卷</el-button
          ...
          <el-table-column prop="title" label="标题" min-width="200">
            <template #default="{ row }">
              <div class="title-cell">
                <span class="title-text" @click="viewQuestionnaire(row.id)">{{
                  row.title
                }}</span>
            ...
            <template #default="{ row }">
              <div class="table-actions">
                ...
                <el-button
                  type="success"
                  size="small"
                  @click="copyQuestionnaire(row.id)"
                >
                  复制
                </el-button>
                <el-button
                ...
                <el-button
                  type="danger"
                  size="small"
                  @click="deleteQuestionnaire(row.id)"
                >
                  删除
                </el-button>
              </div>
...
const deleteQuestionnaire = async (id) => {
  ElMessageBox.confirm("确定要删除这个问卷吗？删除后将无法恢复。", "确认删除", {
