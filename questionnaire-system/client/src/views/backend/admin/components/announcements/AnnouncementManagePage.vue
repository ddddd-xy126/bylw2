  ...
  <div class="announcement-manage-page">
    ...
    <el-card class="filter-card" shadow="never">
      <el-row :gutter="16">
        ...
        <el-col :span="6">
          <el-select v-model="filterType" placeholder="公告类型" clearable @change="handleFilter">
    ...
    <el-card class="list-card" shadow="never">
      <el-table :data="filteredAnnouncements" v-loading="loading" row-key="id">
        ...
        <el-table-column prop="isActive" label="状态" width="100">
          <template #default="{row}">
            <el-tag :type="isAnnouncementActive(row) ? 'success' : 'info'" size="small">
        ...
        <el-table-column label="操作" width="200" fixed="right">
          <template #default="{row}">
            ...
            <el-button type="text" size="small" @click="deleteAnnouncement(row)" class="danger-btn">
      ...
      <!-- 空状态 -->
      <el-empty v-if="!loading && filteredAnnouncements.length === 0" description="暂无公告" />
...
const activeCount = computed(() => announcements.value.filter(a => isAnnouncementActive(a)).length)
